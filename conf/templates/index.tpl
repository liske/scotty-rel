...
<style type="text/css">
@import "res/tabs.css";
@import "lib/jquery/jquery.svg.css";
...
<script type="text/javascript" src="lib/jquery/jquery.svg.min.js"></script>
<script type="text/javascript" src="lib/jquery/jquery.svggraph.min.js"></script>
